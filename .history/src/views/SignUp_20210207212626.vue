...
export default {
  ...
  methods: {
    ...
    validate() {
      ...
      if (
        this.user.name &&
        !(this.user.name.length > 6 && this.user.name.length < 40)
      ) {
        errors.name = "El nombre debe tener entre 6 y 40 carácteres.";
      }
      ...
      if (this.touch) {
        ...
        if (!this.user.lastName) errors.fisrtName = "Este campo es obligatorio.";
