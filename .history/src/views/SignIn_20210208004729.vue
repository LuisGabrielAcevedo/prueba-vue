<template>
  <div class="signIn">
    <div class="signIn__content">
      <span class="signIn">¡ENCUENTRA EN LOS EMPAQUES DE MARGARITA LOS TAZOS CON</span>
      <span>LOS <span>GOLAZOS ICÓNICOS</span> DE LA UEFA CHAMPIONS LEAGUE Y</span>
      <span>PARTICIPA POR INCREIBLES PREMIOS!</span>
    <img
      class="signIn__image"
