<template>
  <div class="myAccount">
    <div class="myAccount__content">
      ...
      <div>
        <span class="myAccount__description">¡Bienvenido, <span class="myAccount__redDescription">Felipe López</span>!</span><br>
      ...
      <div class="table">
        ...
        <div class="table__data">
          <div class="table__data-item" v-for="(item, i) in winners" :key="i">
            <span class="table__header-item">{{ i + 1 }}</span>
            <span class="table__header-item">{{item.code}}</span>
            <span class="table__header-item">{{item.date}}</span>
            <span class="table__header-item">{{item.awarad}}</span>
          </div>
        </div>
      </div>
      <div class="myAccount__footer">
          <div class="myAccount__footer-row">
            ...
            <div class="myAccount__footer-row-content">
              <span class="myAccount__footer-row-number">8</span>
            </div>
          </div>
      </div>
    </div>
